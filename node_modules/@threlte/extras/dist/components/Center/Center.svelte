...
export const calculate = () => {
    ...
    outerGroup.position.set(x === false ? 0 : -center.x + hAlign, y === false ? 0 : -center.y + vAlign, z === false ? 0 : -center.z + dAlign);
    dispatch('center', {
        boundingBox: box3,
 ...
 */
const { start: scheduleCentering, stop } = useFrame(({ invalidate }) => {
    calculate();
    invalidate();
    stop();
}, {
